     ...
     while (solved != 1):
        ...
        for row in rows:
            ...
            for idc,col in enumerate(cols):
                ...
                elif (result =='absent' and col.text.lower() not in wrongList and col.text.lower() not in greenChars):
            ...
            for gchar in greenList:
                if(greenList[gchar] != ""):
                    ...
                    if greenList[gchar] not in greenChars:
                        greenChars.append(greenList[gchar])
                else:
